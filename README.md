...
currentCentroids表存放本簇中心点坐标√ ClusterErrorSum表存放误差平方和SSE√ clusterAssment簇所属表，存放所属的簇的中心号，到簇中心的距离平方 √   
全体样本与所属簇的从属关系： 样本⁮点 → 簇中心 （所属簇的中心号，到簇中心的距离平方）    

母簇：本簇的扩展，程序中本簇的主要代表者，不另行命名 母簇（Index：本簇中心号，子簇中心坐标,分裂后的残差，子簇划分带来的误差平方和降低量）   
